              ...
              <div className="flex items-center">
                ...
                <div className="sm:block sm:ml-6">
                  <div className="flex space-x-4">
                    ...
                    <a href="/" className="hidden lg:inline-block bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">
                      Home
                    </a>
                    <a
                      href="/about"
                    ...
                    <div>
                      <Menu.Button className="hidden lg:inline-block bg-gray-800 text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                        ...
                        <div className="space-x-8 rounded-full py-1 pr-1 pl-4 bg-gray-700">
                          <span className="text-gray-300">Ivan G.<ChevronDownIcon className="hidden lg:inline-block h-5 w-5 ml-2 -mr-1" /></span>
                          <img
          ...
          <Disclosure.Panel className="lg:hidden">
            ...
            <div className="pt-4 pb-3 border-t border-gray-700">
              <div className="flex items-center px-5">
                ...
                <div className="ml-3">
                  <div className="text-base font-medium text-white">Ivan Guzman</div>
                  <div className="text-sm font-medium text-gray-400">ivanguzmandev@gmail.com</div>
                </div>
              </div>

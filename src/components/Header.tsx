...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group rounded-full bg-white/90 px-3 py-3 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20"
    ...
    >
      ...
      <MoonIcon className="hidden h-5 w-5 fill-zinc-700 stroke-zinc-500 transition not-[@media_(prefers-color-scheme:dark)]:fill-violet-400/10 not-[@media_(prefers-color-scheme:dark)]:stroke-violet-500 dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400" />
    </button>
  )
}
  ...
  return (
    <>
      ...
      >
        <div
          ref={headerRef}
          className="top-0 right-0 left-0 z-10 h-16 pt-6"
          style={{
            position:

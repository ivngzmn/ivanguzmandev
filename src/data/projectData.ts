...
export const allProjects: Project[] = [
  ...
  },
  {
    ...
    category: 'Full-Stack',
    liveLink: 'https://pronto-coffee-co-marketing.onrender.com/',
    githubLink: 'https://github.com/ivngzmn/pronto-coffee-co',
    imageSrc: prontoCoffeeCo,
    imageAlt: 'Pronto Coffee Co. Website',
    icons: [
      {
        id: '1',
        name: 'React',
    ...
    description: `A full-stack coffee shop platform with online ordering, staff management, and customer authentication. Built with a monorepo architecture featuring a React staff app, Astro marketing site, and Express.js backend with MongoDB. Integrated OAuth social login and a unified menu system shared across customer and staff interfaces. Deployed on Render.`,
    isPrivate: true,
  },
  // {
  //   id: '8',

...
export default function Uses() {
  return (
    <SimpleLayout
      ...
      intro="I often find myself chatting about the tools and gadgets that power my software-building adventures. Whether it's for boosting productivity or those guilty pleasures that make procrastination a bit more fun, I've got a bunch of favorites to share. So, dive into my carefully curated list and discover something new for your own toolkit!"
    >
      <div className="space-y-20">
        <ToolsSection title="Workstation">
          ...
          <Tool title="BenQ ScreenBar Halo Monitor Light">
            This light comes in great for those long hours in front of the
            screen. My eyes are thankful for it.
          </Tool>
          <Tool title="Kinesis Advantage360 Split Ergonomic Keyboard KB360">
            When it comes to all day comfort while coding away this keyboard is
            a life saver on my wrists. It only took a few weeks to get used to
            the split keyboard layout. Never going back to a regular keyboard.
          </Tool>
        ...
        <ToolsSection title="Development tools">
          ...
          <Tool title="Visual Studio Code">
            I use VS Code for all other project outside of PHP. It&apos;s a text
            editor what more can I say.
          </Tool>
          ...
          <Tool title="Warp">
            ...
            just part of the macOS Terminal but It&apos;s fast and it&apos;s
        ...
        <ToolsSection title="Productivity">
          ...
          <Tool title="Raycast">
            It&apos;s the new kid on the block. It has great support for custom
            plugins from the community.
          </Tool>
          <Tool title="Notion">
            I use Notion for everything. It&apos;s my personal wiki, my todo
            lists, my calendar, and my notes.
          </Tool>
        </ToolsSection>
      </div>
    </SimpleLayout>
